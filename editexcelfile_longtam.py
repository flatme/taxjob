...
df_bienlai_unt['PhuongXa'] = 'Phường Long Tâm'
...
df_bienlai_unt[['MaDTNT','TenDTNT','ToThon','PhuongXa','SoBL','SoTien','NopCham','NgayBL','TrangThai','QuyenBL','KyThue','SoThua','SoTo']].to_excel("longtam_final.xlsx")
