...
df_bienlai_unt['PhuongXa'] = 'Xã Long Phước'
...
df_bienlai_unt[['MaDTNT','TenDTNT','ToThon','PhuongXa','SoBL','SoTien','NopCham','NgayBL','TrangThai','QuyenBL','KyThue','SoThua','SoTo']].to_excel("longphuoc_final.xlsx")
